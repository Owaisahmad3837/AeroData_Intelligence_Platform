...
validation_good_data_folder = Path(
    "data/validation/good/flight_data"
)

validation_bad_data_folder = Path(
    "data/validation/bad/flight_data"
)

flight_raw_data = Path(
    "data/raw/flight_data/flight_data_2024.csv"
)

output_good_data = Path(
    "data/validation/good/flight_data/flight_data.csv"
)

output_bad_data = Path(
    "data/validation/bad/flight_data/flight_data.csv"
)
...
def flight_validation():
    ...
    validation_good_data_folder.mkdir(
        parents=True,
        exist_ok=True
    )

    validation_bad_data_folder.mkdir(
        parents=True,
        exist_ok=True
    )

    logger.info("Validation folders checked/created.")
